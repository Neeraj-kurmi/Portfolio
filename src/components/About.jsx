          ...
          <div className='flex gap-3 py-4'>
            ...
            <div className='flex gap-3 py-4'>
                ...
                <span className='w-96'>
                    ...
                    <p>I began my journey in tech with a curiosity for how websites are built and the technology behind them. This fascination led me to dive deep into web development, where I discovered the power of the Full stack. With its robust features and flexibility, I found it to be the perfect toolkit for crafting modern web applications that are both responsive and user-friendly.</p>
                </span>
            </div>
            <div className='flex gap-3 py-4'>
                <ImArrowRight2 size={30} className="mt-1"/>
            ...
            <div className='flex gap-3 py-4'>
                ...
                <span className='w-96'>
                    ...
                    <p>I'm backend developer and love to work with spring boot , mongodb , SQL.</p>
                </span>
            </div>
          </ul>
        </div>
